...
|geomorph | Widely used R package for multivariate analysis with shape data | [^6]| |[View Analysis Page](https://cran.r-project.org/web/packages/geomorph/index.html)|
