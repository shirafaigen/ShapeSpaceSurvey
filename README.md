...
|geomorph | Widely used R package for multivariate analysis with shape data | [^6]| |[Geomorph R Package](https://cran.r-project.org/web/packages/geomorph/index.html)|
