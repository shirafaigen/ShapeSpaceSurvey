...
|geomorph | Widely used R package for multivariate analysis with shape data | [^6]| |<a href="https://cran.r-project.org/web/packages/geomorph/index.html">geomorph CRAN Package</a>|
